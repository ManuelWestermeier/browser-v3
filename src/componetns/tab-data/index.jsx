...
export default function TabData() {
    ...
    return <div className="top-tab">
        ...
        <form onSubmit={e => {
            ...
            <input defaultValue={openTab.url} key={openTabId} id='url-input' type="url" required name='url' placeholder='url...' />
        ...
        <button id='reload-button' className={document.getElementById(openTabId)?.isLoading?.() ? "loading" : ""} title='Reload' type='button' onClick={() => document.getElementById(openTabId)?.reload?.()}>
